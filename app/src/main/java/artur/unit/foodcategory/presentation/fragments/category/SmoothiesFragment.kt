...
import artur.unit.foodcategory.databinding.FragmentSmoothiesBinding
...
class SmoothiesFragment : Fragment() {
    private lateinit var binding: FragmentSmoothiesBinding
    private lateinit var viewModel: DataViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
    ): View {
        binding = FragmentSmoothiesBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.submitList(viewModel.foodList[3].list)
    }
}
